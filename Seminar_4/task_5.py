...
def count_words(file_path, cnt):
    ...
    print(f'Now counter: {cnt.value:_} words. Count in {time.time() - start_time:.4f} seconds')
...
if __name__ == '__main__':
    ...
    print(f'Final counter: {counter.value:_} words. Count in {time.time() - start_time:.4f} seconds')
